#ifndef _POTATOS_INC_MEMLAYOUT_H_
#define _POTATOS_INC_MEMLAYOUT_H_
...
/**
 * This file contains definitions for memory management in PotatOS,
 ...
 *                     |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|
 *                     |     Program Data & Heap      |
 *    UTEXT -------->  +------------------------------+ 0x00800000 1MB
 *    PFTEMP ------->  |       Empty Memory (*)       |        PTSIZE
 *                     |                              |
 *    UTEMP -------->  +------------------------------+ 0x00400000 512KB --+
 *                     |       Empty Memory (*)       |                    |
 *                     | - - - - - - - - - - - - - - -|                    |
 *                     |  User STAB Data (optional)   |                  PTSIZE
 *    USTABDATA ---->  +------------------------------+ 0x00200000 256KB   |
 *                     |       Empty Memory (*)       |                    |
 *    0 ------------>  +------------------------------+                  --+
 *
 * (*) Note: The kernel ensures that "Invalid Memory" (ULIM) is *never*
 *     mapped.  "Empty Memory" is normally unmapped, but user programs may
 *     map pages there if desired. Potato user programs map pages temporarily
 *     at UTEMP.
 */
...
/**
 *
 * User read-only mappings! Anything below here until UTOP are
 * read-only to user. They are global pages mapped in at env allocation time.
 *
 */
...
#endif  // !_POTATOS_INC_MEMLAYOUT_H_
