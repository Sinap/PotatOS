...
#define FEC_PR      0x1 // Page fault caused by protection
#define FEC_WR      0x2 // Page fault caused by a write
#define FEC_U       0x4 // Page fault occurred while in user mode
...
struct Gatedesc {
    ...
    unsigned gd_dpl         :1;     // descriptor (meaning new) privilege level
